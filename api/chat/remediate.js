module.exports = async (req, res) => {
  ...
  const KNOWLEDGE = {
    ...
    "virus": {
      message: "Topic: Virus / Malware\n\nQuick guidance: If a scan flags a file as Known Malware, treat it as compromised and do not open it.",
